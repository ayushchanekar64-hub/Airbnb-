...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = async () => {
    try {
      // Mock Google sign-in - in real app, you'd use Google OAuth
      const mockGoogleUser = {
        email: 'googleuser@example.com',
        name: 'Google User',
        password: 'google123', // Mock password for demo
      };
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <Card className="w-full max-w-md bg-gray-800 border-gray-700 shadow-2xl">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl font-bold text-center text-white">Sign in to StayEase</CardTitle>
